...
Install "tesseract-ocr-w64-setup-5.3.3.20231005" that the folder includes, INSTALL IT AND THEN COPY THEP PATH WHERE YOU INSTALLED IT (it should be something like "C:\Program Files\Tesseract-OCR"), once installed, go to "Edit the system enviroment variables" on your pc, (press Windows Key, then search edit system enviroment, you'll see it, it will open a System Properties window) then press "Enviroment variables..." at the bottom, press "Path" (not PATHEXT) and then  "Edit..." at the bottom, it will pop up a window where you'll press "New" and paste the path that you copied at the start (something like something like "C:\Program Files\Tesseract-OCR") click accept, accept, accept and follow the next instructions.
